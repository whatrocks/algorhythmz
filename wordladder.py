# Transform word one letter at a time but each transform must
# be another word.

# Represent the relationships between the words as a graph
# Use breadth first search to find an efficient path from starting word to
# the ending word
...
def get_words(vocabulary_file):
    for line in open(vocabulary_file, 'r'):
        yield line[:-1] # remove the newline character
